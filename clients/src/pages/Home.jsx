...
function Home() {
    ...
    <>
      ...
      <div className="">
        <div className='flex'>
          {
            !showProfile ?
            <div className="md:flex md:flex-col  h-[100vh] md:h-[98.6vh] bg-[#F0EEED] relative">           
                <div className='h-[61px] px-4'>
                  <div className='flex'>
                    <a className='flex items-center relative  -top-4 block h-[90px]' href='/'>

                      <h3 className='text-[30px] text-[#191D88] font-body font-extrabold tracking-wider'>VT</h3>
                    </a>
                  </div>
    ...
    <form onSubmit={(e) => e.preventDefault()}>
      <div className="relative">
        ...
        <div
          ...
          onClick={() => setTapsearch((item) => !item)}
        >
          <div
  ...
  style={{ position: 'absolute', top: '100%', left: '35%', transform: 'translateY(-50%)' }}
  onClick={() => setTapsearch((item) => !item)}
>
  <div
    style={{ color: '#616c76', height: '14px', width: '14px' }}
...
{/* </div> */}
          ...
          <Chat className="chat-page relative lg:w-[100%] h-[100vh] bg-[#E6FFFD]" />
          {/* </div> */}
